...
def test_step0():
    ...
    res.append(ssh_checkout("0.0.0.0", "user2", "54321", "echo '54321' | sudo -S dpkg -i /home/user2/p7zip-full.deb",
                            "Настраивается пакет"))
    res.append(ssh_checkout("0.0.0.0", "usr2", "54321", "echo '54321' | sudo -S dpkg -s p7zip-full",
